...
<xsl:for-each select="INDICE_ATTIVITA">
	...
	<div style="padding:6px 3px 6px 3px; font-weight:bold; background-color:#000000;border-bottom:2px solid #ffffff;">
	<span style="font-size:11px;color:#ffffff;"><xsl:value-of select="@nome"/></span><br />
	<span style="font-size:11px;color:#ffffff;">Indice di attivita'</span>
	</div>
	<div>
	<div style="margin:10px;padding:0 0 8px 0;border-bottom:1px dotted #ffffff;font-weight:bold;">
	<span style="display:block;padding:0 0 5px 0;color:#ffffff">Indice: <span style="background-color:#10952a;color:#ffffff;padding:3px;color:#ffffff;"><xsl:value-of select="INDICE"/></span> (min 0 - max 10) </span>
