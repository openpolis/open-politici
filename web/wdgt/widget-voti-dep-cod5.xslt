...
<div style="border:1px solid #9a9797;width:{$dimensione}; background-image:url(http://www.openpolis.it/images/widget/bg5.png); background-repeat:repeat-x; background-position:left bottom;background-color:#dfdddd">
...
<div style="padding:6px 3px 6px 3px; font-weight:bold; background-color:#a7a6a6;color:#ffffff;">
...
<span style="font-family:Arial, Helvetica, sans-serif;font-size:10px;color:#000000">Voti chiave in parlamento<br />
</span>
</xsl:for-each>
</xsl:for-each>
</div>
...
<xsl:value-of select="string(../../../DEPUTATO/@url_openpolis)"/>
</xsl:attribute>
<xsl:attribute name="style">
font-weight:bold;color:#2a76d4;text-decoration:none;
</xsl:attribute>
<strong><xsl:value-of select="string(../TITOLO)"/> </strong>
</a>
<br />
<span style="font-weight:bold;">Voto:</span> <span style="font-weight:bold;color:#2a76d4"><xsl:value-of select="string(../VOTO_ESPRESSO)"/></span><br />
<span style="font-weight:bold;">Esito:</span> <span style="font-weight:bold;color:#2a76d4;"><xsl:value-of select="string(../ESITO)"/></span><br />
</li>
