...
<div style="border:1px solid #9a9797;width:{$dimensione}; background-image:url(http://www.openpolis.it/images/widget/bg3.png); background-repeat:repeat-x; background-position:left bottom">
...
<xsl:for-each select="INDICE_ATTIVITA">
	...
	<div style="padding:6px 3px 6px 3px; font-weight:bold; background-color:#d9d9d9;">
	...
	<span style="display:block;padding:0 0 5px 0;color:#2a76d4;color:#000000;font-size:13px;"><xsl:value-of select="POSIZIONE"/>° su <xsl:value-of select="$totale_senatori"/></span>
	<span>
	<img>
...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="font-weight:bold;color:#9a9797;margin:0 10px 10px 10px;font-size:10px;">
...
font-weight:bold;color:#9a9797;margin:0 10px 10px 10px;font-size:10px;
</xsl:attribute>
<xsl:attribute name="style">
font-weight:bold;color:#9a9797;margin:0 10px 10px 10px;font-size:10px;
</xsl:attribute>
...
<td style="padding:5px 0 5px 0;text-align:center;color:#9a9797;">
