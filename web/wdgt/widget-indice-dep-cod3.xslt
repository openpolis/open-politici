...
<xsl:for-each select="INDICE_ATTIVITA">
	...
	<span style="display:block;padding:0 0 5px 0;color:#2a76d4;color:#000000;font-size:13px;"><xsl:value-of select="POSIZIONE"/>° su <xsl:value-of select="$totale_deputati"/></span>
	<span>
	<img>
