...
<div style="border:1px solid #9a9797;width:{$dimensione}; background-image:url(http://www.openpolis.it/images/widget/bg2.png); background-repeat:repeat-x; background-position:left bottom">
