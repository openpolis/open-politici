...
<br />
<span style="font-weight:bold;color:#9a9797;">Voto:</span> <span style="font-weight:bold;color:#000000;"><xsl:value-of select="string(../VOTO_ESPRESSO)"/></span><br />
<span style="font-weight:bold;color:#9a9797;">Esito:</span> <span style="font-weight:bold;color:#000000;"><xsl:value-of select="string(../ESITO)"/></span><br />
</li>
