...
<div style="border:1px solid #9a9797;width:{$dimensione}; background-image:url(http://www.openpolis.it/images/widget/bg1.png); background-repeat:repeat-x; background-position:left bottom">
...
<div style="padding:6px 3px 6px 3px; font-weight:bold; background-color:#dfebf9;">
...
<span style="font-family:Arial, Helvetica, sans-serif;font-size:10px;">Presenze in Parlamento<br />
...
<li style="list-style-type:none; padding:8px 0 8px 10px;border-bottom:1px dotted #2a76d4">
<span style="font-family:Arial, Helvetica, sans-serif;font-size:10px;"><strong>PRESENTE</strong></span><br />
<span style="font-family:Arial, Helvetica, sans-serif;font-size:10px;font-weight:bold;color:#2a76d4;width:80px;display:block;float:left;">
...
<li style="list-style-type:none; padding:8px 0 8px 10px;border-bottom:1px dotted #2a76d4">
<span style="font-family:Arial, Helvetica, sans-serif;font-size:10px;"><strong>ASSENTE</strong></span><br />
<span style="font-family:Arial, Helvetica, sans-serif;font-size:10px;font-weight:bold;color:#2a76d4;width:80px;display:block;float:left;">
...
<li style="list-style-type:none; padding:8px 0 8px 10px;border-bottom:1px dotted #2a76d4">
<span style="font-family:Arial, Helvetica, sans-serif;font-size:10px;"><strong>IN MISSIONE </strong></span><br />
<span style="font-family:Arial, Helvetica, sans-serif;font-size:10px;font-weight:bold;color:#2a76d4;width:80px;display:block;float:left;">
...
<span style="font-weight:bold;display:block;border:0;">
												<xsl:choose>
