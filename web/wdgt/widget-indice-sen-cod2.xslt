...
<xsl:for-each select="INDICE_ATTIVITA">
	...
	<span style="display:block;padding:0 0 5px 0;color:#2a76d4;font-size:13px;"><xsl:value-of select="POSIZIONE"/>° su <xsl:value-of select="$totale_senatori"/></span>
	<span>
	<img>
...
<td style="padding:5px 0 5px 0;text-align:center;color:#000000;">
