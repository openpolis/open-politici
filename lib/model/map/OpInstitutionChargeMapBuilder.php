...
/**
 * This class adds structure of 'op_institution_charge' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class OpInstitutionChargeMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.OpInstitutionChargeMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('op_institution_charge');
		$tMap->setPhpName('OpInstitutionCharge');
		...
		$tMap->addForeignKey('INSTITUTION_ID', 'InstitutionId', 'int', CreoleTypes::INTEGER, 'op_institution', 'ID', true, null);
		...
		$tMap->addForeignKey('CONSTITUENCY_ID', 'ConstituencyId', 'int', CreoleTypes::INTEGER, 'op_constituency', 'ID', false, null);

		$tMap->addForeignKey('PARTY_ID', 'PartyId', 'int', CreoleTypes::INTEGER, 'op_party', 'ID', true, null);

		$tMap->addForeignKey('GROUP_ID', 'GroupId', 'int', CreoleTypes::INTEGER, 'op_group', 'ID', true, null);
		...
		$tMap->addColumn('MININT_VERIFIED_AT', 'MinintVerifiedAt', 'int', CreoleTypes::TIMESTAMP, false, null);

	} // doBuild()

} // OpInstitutionChargeMapBuilder
