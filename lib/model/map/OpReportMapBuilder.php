...
/**
 * This class adds structure of 'op_report' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class OpReportMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.OpReportMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('op_report');
		$tMap->setPhpName('OpReport');
