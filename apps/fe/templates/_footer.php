...
<footer class="container">
    ...
    <nav id="sub-footer" class="row">
	    ...
	    <li><a href="http://www.openpolis.it"><img src="/images/footers/openpolis.png" alt="Sito dell'associazione OpenPolis" title="Associazione Openpolis" /></a></li>
            ...
            <li><a href="http://indice.openpolis.it/"><img src="/images/footers/indiceproduttivita.png" alt="L'Indice di Produttività Parlamentare" title="L'Indice di Produttività Parlamentare" /></a></li>
        </ul>            
    </nav>
</footer>
