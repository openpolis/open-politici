...
<div class="genericblock">
  <div class="header">
    <span class="rights-elements">
      <?php echo link_to(image_tag('buttons/close.png', array('id' => 'politician_users_container_toggle_img', 'alt'=>'Chiudi blocco', 'width'=>'15', 'height'=>'14')) , '#', array('title'=>'', 'hreflang'=>'it', 'lang'=>'it', 'onclick' => 'return toggleContainer(\'politician_users_container\')')) ?> 
    </span>
    <h3>Utenti pi&ugrave; attivi</h3>
  </div>
  <div id="politician_users_container" class="nickblock">
    <ul>
