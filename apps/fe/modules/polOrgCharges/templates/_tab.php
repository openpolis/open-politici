...
<div class="table-container">
  ...
  <?php foreach ($organization_charges as $organization_charge): ?>
    <tr class="<?php echo $tr_class;?>">
      <?php include_partial('polOrgCharges/show', array('organization_charge' => $organization_charge)) ?>
	</tr>
  ...
  <?php foreach ($past_organization_charges as $past_organization_charge): ?>
    <tr class="<?php echo $tr_class;?>">
      <?php include_partial('polOrgCharges/show', array('organization_charge' => $past_organization_charge)) ?>
	</tr>
	<?php $tr_class = ($tr_class=='dark' ? 'light' : 'dark'); ?>	
  <?php endforeach; ?>
</table>
