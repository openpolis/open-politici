...
<div id="politician_cloud_container" class="genericblock">
  ...
  <div class="sottomenu">
  <?php echo link_to_remote('settimana', array('update' => 'politician_cloud_container', 'url' => 'sidebar/politiciansForTagCloud?period=week&tag_id='.$tag_id)) ?>
    &nbsp;&nbsp;|&nbsp;&nbsp;
	<?php echo link_to_remote('mese', array('update' => 'politician_cloud_container', 'url' => 'sidebar/politiciansForTagCloud?period=mounth&tag_id='.$tag_id)) ?>
	&nbsp;&nbsp;|&nbsp;&nbsp;
	sempre
  </div>
  <div class="textblock">
