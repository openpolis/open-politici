...
<div class="sottomenu">
  <?php echo($period=='week' ? 'settimana' : link_to_remote('settimana', array('update' => 'tag_cloud_container', 'url' => 'sidebar/institutionTagsCloud?id='.$location_id.'&period=week')) ) ?>
  &nbsp;&nbsp;|&nbsp;&nbsp;
  <?php echo($period=='mounth' ? 'mese' : link_to_remote('mese', array('update' => 'tag_cloud_container', 'url' => 'sidebar/institutionTagsCloud?id='.$location_id.'&period=mounth')) ) ?>
  &nbsp;&nbsp;|&nbsp;&nbsp;
  <?php echo($period=='all' ? 'sempre' : link_to_remote('sempre', array('update' => 'tag_cloud_container', 'url' => 'sidebar/institutionTagsCloud?id='.$location_id.'&period=all')) ) ?>
</div>
<div class="textblock">
