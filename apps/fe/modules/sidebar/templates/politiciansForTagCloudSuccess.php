...
<div class="header">
  ...
  <h3>Politici con pi&uacute; dichiarazioni sull'argomento</h3>
</div>
<div class="sottomenu">
  <?php echo($period=='week' ? 'settimana' : link_to_remote('settimana', array('update' => 'politician_cloud_container', 'url' => 'sidebar/politiciansForTagCloud?period=week&tag_id='.$tag_id)) ) ?>
  &nbsp;&nbsp;|&nbsp;&nbsp;
  <?php echo($period=='mounth' ? 'mese' : link_to_remote('mese', array('update' => 'politician_cloud_container', 'url' => 'sidebar/politiciansForTagCloud?period=mounth&tag_id='.$tag_id)) ) ?>
  &nbsp;&nbsp;|&nbsp;&nbsp;
  <?php echo($period=='all' ? 'sempre' : link_to_remote('sempre', array('update' => 'politician_cloud_container', 'url' => 'sidebar/politiciansForTagCloud?period=all&tag_id='.$tag_id)) ) ?>
</div>
<div class="textblock">
