...
<div class="genericblock">
  <div class="header">
    <span class="rights-elements">
      <?php echo link_to(image_tag('symbols/rss.png', array('alt'=>'Esporta RSS', 'width'=>'23', 'height'=>'12', 'border'=>'0')), '@feed_institution_declarations?institution_id='.$sf_params->get('id'), array('title'=>'', 'hreflang'=>'it', 'lang'=>'it', 'xml:lang'=>'it')) ?>
  ...
  <div id="declaration_list" class="textblock">
	...
	<?php if ($total_declarations>10): ?>
	  <?php echo link_to_remote('&raquo; Leggi le ultime 50 dichiarazioni', array('update' => 'declaration_list', 'url' => 'sidebar/institutionFeed?id='.$sf_params->get('id'))) ?>
    <?php endif; ?>
  </div>
</div>
<hr />
