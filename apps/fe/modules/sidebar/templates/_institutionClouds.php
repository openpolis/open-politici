...
<div id="tag_cloud_container" class="genericblock">
  <div class="header">
    ...
    <h3>Argomenti pi&uacute; discussi</h3>
  </div>
  
    <div class="sottomenu">
  <?php echo link_to_remote('settimana', array('update' => 'tag_cloud_container', 'url' => 'sidebar/institutionTagsCloud?id='.$location_id.'&period=week')) ?>
    &nbsp;&nbsp;|&nbsp;&nbsp;
	<?php echo link_to_remote('mese', array('update' => 'tag_cloud_container', 'url' => 'sidebar/institutionTagsCloud?id='.$location_id.'&period=mounth')) ?>
	&nbsp;&nbsp;|&nbsp;&nbsp;
	sempre
  </div>
...
<div id="politician_cloud_container" class="genericblock">
  ...
  <div class="sottomenu">
  <?php echo link_to_remote('settimana', array('update' => 'politician_cloud_container', 'url' => 'sidebar/institutionPoliticiansCloud?id='.$location_id.'&period=week')) ?>
    &nbsp;&nbsp;|&nbsp;&nbsp;
	<?php echo link_to_remote('mese', array('update' => 'politician_cloud_container', 'url' => 'sidebar/institutionPoliticiansCloud?id='.$location_id.'&period=mounth')) ?>
	&nbsp;&nbsp;|&nbsp;&nbsp;
	sempre
  </div>
  <div class="textblock">
