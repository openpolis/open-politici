  ...
  <div style="float:left">
    <?php if ($pager->getNbResults() > 1): ?>
      <?php if ($pager->getNbResults() > $limit): ?>
        <?php echo $items_name ?> <strong><?php echo $pager->getFirstIndice() ?></strong> - 
               <strong><?php echo $pager->getLastIndice() ?></strong> di
               <strong><?php echo $pager->getNbResults() ?></strong>
      <?php else: ?>
        <strong><?php echo $pager->getNbResults()?></strong> <?php echo $items_name ?>
      <?php endif; ?>
    <?php else: ?>
      <?php if ($pager->getNbResults() == 1): ?>
        <?php echo $single_item_found ?>.
      <?php endif; ?>
    <?php endif; ?>
  </div>
