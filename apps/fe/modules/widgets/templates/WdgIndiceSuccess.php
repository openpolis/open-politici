...
<br />
<h3 class="widget">Hai scelto di pubblicare l'indice di attivit&agrave; parlamentare di <?php echo ucwords(strtolower($politician->getFirstName())) ?>&nbsp;<span class="surname"><?php echo $politician->getLastName() ?>.</h3>
...
<tr>
<td><img src="/images/widget/indice1.jpg" alt=" " width="130" height="170" /></td>
<td><img src="/images/widget/indice2.jpg" alt=" " width="130" height="170" /></td>
<td><img src="/images/widget/indice3.jpg" alt=" " width="130" height="170" /></td>
</tr>
<tr>
...
<tr>
<td><img src="/images/widget/indice4.jpg" alt=" " width="130" height="170" /></td>
<td><img src="/images/widget/indice5.jpg" alt=" " width="130" height="170" /></td>
<td><img src="/images/widget/indice6.jpg" alt=" " width="130" height="170" /></td>
</tr>
<tr>
...
<tr class="light">
<td><label for="Submit"><input name="Submit" type="button" class="genera" id="Submit" value="Genera codice" onclick="impostaCodice('codice',<?php echo $id_politico;?>,'Indice')"/></label></td>
</tr>
</table>
</form>
<br />
...
<input name="Submit" type="button" class="preview" id="Preview" value="Preview" onclick="showPreviews('<?php echo ucwords(strtolower($politician->getFirstName())) ?>&nbsp;<?php echo $politician->getLastName() ?>','codice','<?php echo $id_politico;?>','Indice')" />
