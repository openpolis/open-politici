...
<br />
<h3 class="widget">Hai scelto di pubblicare i voti chiave di <?php echo ucwords(strtolower($politician->getFirstName())) ?>&nbsp;<span class="surname"><?php echo $politician->getLastName() ?>.</h3>
...
<tr>
<td><img src="/images/widget/voti1.jpg" alt=" " width="130" height="170" /></td>
<td><img src="/images/widget/voti2.jpg" alt=" " width="130" height="170" /></td>
<td><img src="/images/widget/voti3.jpg" alt=" " width="130" height="170" /></td>
</tr>
<tr>
...
<tr>
<td><img src="/images/widget/voti4.jpg" alt=" " width="130" height="170" /></td>
<td><img src="/images/widget/voti5.jpg" alt=" " width="130" height="170" /></td>
<td><img src="/images/widget/voti6.jpg" alt=" " width="130" height="170" /></td>
</tr>
<tr>
...
<tr class="light">
<td><label for="Submit"><input name="Submit" type="button" class="genera" id="Submit" value="Genera codice" onclick="impostaCodice('codice',<?php echo $id_politico;?>,'Voti')"/></label></td>
</tr>
</table>
</form>
<br />
...
<input name="Submit" type="button" class="preview" id="Preview" value="Preview" onclick="showPreviews('<?php echo ucwords(strtolower($politician->getFirstName())) ?>&nbsp;<?php echo $politician->getLastName() ?>','codice','<?php echo $id_politico;?>','Voti')" />
